  ...
  return (
    <>
      ...
      <main className="pt-20">
        {/* Hero Section */}
        <section className="relative py-24 bg-gradient-to-br from-primary via-pine-deep to-primary overflow-hidden">
        ...
        {/* Seasons Section */}
        <section id="seasons" className="py-24 bg-background">
          <div className="container mx-auto px-4 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {seasons.map((season, index) => (
                ...
                >
                  <div className={`w-12 h-12 rounded-xl ${season.color} flex items-center justify-center mb-4`}>
                  ...
                  <ul className="space-y-2">
                    {season.highlights.map((highlight) => (
                      <li key={highlight} className="flex items-center gap-2 font-body text-sm text-foreground">
        ...
        {/* Packing Section */}
        <section id="packing" className="py-24 bg-secondary/30">
          <div className="container mx-auto px-4 lg:px-8">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
        ...
        {/* How to Reach */}
        <section id="reach" className="py-24 bg-background">
          <div className="container mx-auto px-4 lg:px-8">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              >
                ...
                <h3 className="font-display text-xl font-semibold text-foreground mb-4">By Air</h3>
              ...
              >
                ...
                <h3 className="font-display text-xl font-semibold text-foreground mb-4">By Bus</h3>
                <p className="font-body text-muted-foreground">
              ...
              >
                ...
                <h3 className="font-display text-xl font-semibold text-foreground mb-4">By Road</h3>
                <p className="font-body text-muted-foreground">
        ...
        {/* Responsible Travel */}
        <section id="responsible" className="py-24 bg-primary">
          <div className="container mx-auto px-4 lg:px-8">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                <ul className="space-y-4">
                  {dosDonts.dos.map((item) => (
                    <li key={item} className="flex items-start gap-3 font-body text-primary-foreground/90">
