...
By using our services, you consent to the transfer of your information to India. We ensure that appropriate safeguards are in place to protect your data in accordance with applicable data protection laws.`
  ...
  return (
    <>
      <SEOHead
        title="Privacy Policy | Local Himachal"
        description="Learn how Local Himachal collects, uses, and protects your personal information. Read our comprehensive privacy policy for travel planning services."
        keywords="privacy policy, data protection, personal information, Local Himachal privacy"
        url="/privacy-policy"
      />
