...
Our total liability for any claim arising from these terms shall not exceed the amount you paid to us for the specific service in question.`
  ...
  return <>
      <SEOHead title="Terms of Service | Local Himachal" description="Read the Terms of Service for Local Himachal. Understand our policies, user agreements, and guidelines for using our travel planning services." keywords="terms of service, user agreement, legal terms, Local Himachal policies" url="/terms-of-service" />
