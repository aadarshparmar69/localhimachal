          ...
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="flex flex-col gap-3 max-w-md mx-auto px-4 sm:px-0">
              <input
                ...
                className="w-full px-4 py-3 rounded-lg bg-primary-foreground/10 border border-primary-foreground/20 text-primary-foreground placeholder:text-primary-foreground/50 focus:outline-none focus:border-primary-foreground/40 font-body min-h-[48px]"
              />
            ...
            <div className="flex items-center gap-3">
              {[
                ...
                <a
                  key={index}
                  href={href}
                  className="p-2.5 sm:p-2 rounded-lg bg-primary-foreground/10 hover:bg-primary-foreground/20 transition-colors min-h-[44px] min-w-[44px] flex items-center justify-center"
            ...
            <ul className="space-y-2 sm:space-y-3">
              {footerLinks.explore.map((link) => (
                <li key={link.path}>
                  <Link
                    to={link.path}
                    className="text-primary-foreground/70 hover:text-primary-foreground transition-colors font-body text-sm sm:text-base py-1 inline-block min-h-[44px] flex items-center"
                  >
                    {link.name}
                  </Link>
                </li>
