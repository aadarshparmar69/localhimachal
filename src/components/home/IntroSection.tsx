...
export const IntroSection = () => {
  ...
  return (
    <section
      ref={containerRef}
      className="py-20 sm:py-32 md:py-48 bg-background relative overflow-hidden"
    >
      {/* Subtle Background Texture - Hidden on mobile for performance */}
      <div 
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="mt-12 sm:mt-16 h-px bg-gradient-to-r from-transparent via-border to-transparent origin-center"
          />
          ...
          <motion.p
            ...
            viewport={{ once: true }}
            className="mt-8 sm:mt-12 text-center font-body text-muted-foreground text-xs sm:text-sm tracking-[0.15em] sm:tracking-[0.2em] uppercase"
          >
...
const IntroLine = ({ line, index, scrollYProgress, start, end }: IntroLineProps) => {
  ...
  return (
    <motion.p
      style={{ opacity, y }}
      className={`font-display text-xl sm:text-2xl md:text-3xl lg:text-4xl text-foreground leading-relaxed tracking-tight ${
