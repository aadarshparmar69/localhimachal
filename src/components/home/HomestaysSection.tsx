            ...
            >
              ...
              <div className="sm:w-2/5 aspect-[16/10] sm:aspect-auto overflow-hidden relative">
                <img
                  ...
                  loading="lazy"
                />
                <div className="absolute top-2 right-2 p-1.5 rounded-full bg-background/80 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300">
