  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Grain Texture */}
        <div 
          className="absolute inset-0 opacity-[0.04] pointer-events-none mix-blend-overlay hidden sm:block"
          style={{
        ...
        >
          <Link to="/explore">
            <Button 
              variant="default" 
              size="lg"
              className="w-full sm:w-auto bg-primary-foreground text-foreground hover:bg-primary-foreground/90 font-medium px-8"
            >
              Explore Districts
            </Button>
          </Link>
          <Link to="/hidden-gems">
            <Button 
              variant="outline" 
              size="lg"
              className="w-full sm:w-auto border-primary-foreground/30 text-primary-foreground hover:bg-primary-foreground/10 font-medium px-8"
            >
              Hidden Gems
            </Button>
          </Link>
      ...
      <motion.button
        ...
        className="absolute bottom-6 sm:bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-primary-foreground/40 hover:text-primary-foreground/70 transition-colors cursor-pointer z-20 min-h-[44px] min-w-[44px] justify-center"
