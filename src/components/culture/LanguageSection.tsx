      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <motion.p
            ...
            viewport={{ once: true }}
            className="font-body text-base sm:text-lg text-muted-foreground leading-relaxed text-center mb-8 sm:mb-12"
          >
          ...
          <motion.blockquote
            ...
            viewport={{ once: true }}
            className="relative bg-card rounded-xl sm:rounded-2xl p-6 sm:p-8 md:p-12 shadow-soft text-center"
          >
            <Quote className="w-8 h-8 sm:w-10 sm:h-10 text-primary/20 mx-auto mb-4 sm:mb-6" />
            <p className="font-display text-lg sm:text-xl md:text-2xl text-foreground italic mb-4 sm:mb-6 leading-relaxed">
              "{languageContent.quote.text}"
            </p>
            <cite className="font-body text-muted-foreground not-italic text-sm sm:text-base">
