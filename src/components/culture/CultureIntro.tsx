      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="w-16 sm:w-24 h-px bg-gradient-to-r from-transparent via-primary to-transparent mx-auto mb-10 sm:mb-16"
          />
          ...
          <div className="space-y-6 sm:space-y-8">
            {introContent.paragraphs.map((paragraph, index) => (
              <motion.p
                ...
                className={`font-body text-base sm:text-lg md:text-xl leading-relaxed ${
                  index === 0 
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="flex items-center justify-center gap-3 sm:gap-4 mt-14 sm:mt-20"
          >
            <span className="w-12 sm:w-16 h-px bg-border" />
            <span className="w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full bg-primary/50" />
            <span className="w-12 sm:w-16 h-px bg-border" />
          </motion.div>
        </div>
      </div>
